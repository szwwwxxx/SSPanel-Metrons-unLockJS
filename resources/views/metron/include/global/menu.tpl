            ...
            <div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
                <div id="kt_header_menu"
                    ...
                    <div class="header-logo-mobile">
                        <a href="/">
                            <h2 class="logo-sticky">{$config["appName"]}</h2>
                        </a>
                    </div>
                    <ul class="menu-nav">
                        <li class="menu-item menu-item-submenu menu-item-rel">
                            <a href="/user" class="menu-link">
                                <i class="fab fa-fort-awesome"></i> <span class="menu-text" style="font-weight: 600"><strong>首页</strong></span>
                            </a>
                        </li>
                        <li class="menu-item menu-item-submenu menu-item-rel">
...
{*                            </a>*}
                        ...
                        <li class="menu-item menu-item-submenu menu-item-rel">
                            <a href="/user/code" class="menu-link">
                                <i class="fas fa-wallet"></i> <span class="menu-text"><strong>我的钱包</strong></span>
                            </a>
                        </li>
                        ...
                        <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click"
                            aria-haspopup="true">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                <span class="menu-text"><i class="fas fa-user"></i>
                                    <strong>审计系统</strong>
                                </span>
                                <span class="menu-desc"></span>
                                <i class="menu-arrow"></i>
                            ...
                            <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                <ul class="menu-subnav">
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="/user/setting/detect?type=2" class="menu-link">
                                                                <span class="svg-icon menu-icon">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                         xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                         width="24px" height="24px" viewBox="0 0 24 24"
                                            ...
                                            <span class="menu-text">审计规则</span>
                                        </a>
                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="/user/setting/detect?type=1" class="menu-link">
                                                                <span class="svg-icon menu-icon">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                         xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                         width="24px" height="24px" viewBox="0 0 24 24"
                                            ...
                                            <span class="menu-text">审计记录</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        {if $user->isAdmin()}
                            <li class="menu-item menu-item-submenu menu-item-rel">
                                <a href="/admin" class="menu-link">
                                    <i class="far flaticon2-settings"/></i><span
                                            class="menu-text"><strong>管理面板</strong></span>
                                </a>
                            </li>
                        {/if}
                        {if $can_backtoadmin}
...
{*                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">*}
{*                                                        <polygon points="0 0 24 0 24 24 0 24"/>*}
{*                                                        <path d="M8,14 C8,11.790861 9.790861,10 12,10 C14.209139,10 16,11.790861 16,14 C16,14 8,14 8,14 Z"*}
{*                                                              fill="#000000" fill-rule="nonzero"/>*}
...
{*                                                {/if}*}
{*                                            </span>*}
{*                        <span class="text-white opacity-90 font-weight-bolder font-size-base d-none d-md-inline ml-2"*}
{*                              style="white-space: nowrap;">外观</span>*}
{*                    </div>*}
{*                </div>*}
...
{*                            <img src="{$user->gravatar}" alt=""/>*}
{*                        </div>*}
{*                        <div class="{$style[$theme_style]['global']['title']} m-0 flex-grow-1 mr-3 font-size-h5">*}
{*                            &nbsp;<strong>{$user->user_name}</strong></div>*}
...
{*                            <a href="/user/logout"*}
{*                               class="btn {$style[$theme_style]['modal']['btn_close']} font-weight-bold">退出登录</a>*}
{*                        </div>*}
{*                    </div>*}
{*                </div>*}
            </div>
